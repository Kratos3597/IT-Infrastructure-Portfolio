...
| :--- | :--- | :--- | :--- |
| `Active Directory & Infrastructure Script ADInfrastructure.ps1` | Hybrid / On-Premises AD | Automates stale account remediation, checks disk space thresholds, and flags failed critical services. | `ActiveDirectory`, `CimCmdlets` |
